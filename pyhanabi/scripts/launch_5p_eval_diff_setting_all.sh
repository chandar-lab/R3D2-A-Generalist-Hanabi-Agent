...
players=(
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/5/20/a/epoch2540.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/5/20/a/epoch2040.pthw"
)

alternatives_2=(
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/5/20/b/epoch2520.pthw"
...
alternatives_3=(
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/5/20/c/epoch2520.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/5/20/c/epoch2040.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/2/20/c/epoch2000.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/3/20/b/epoch3000.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/4/20/b/epoch2860.pthw"
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/2/20/d/epoch1900.pthw"
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/3/20/d/epoch1980.pthw"
...
alternatives_4=(
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/5/20/d/epoch1960.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/5/20/a/epoch2020.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/2/20/d/epoch2000.pthw"
  ...
  "${SCRATCH}/final_hanabi_checkpoint/multitask_learning_no_saved_buffer/6/20/c/epoch3240.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/random_agent/2p/epoch0.pthw"
)

alternatives_5=(
  "${SCRATCH}/v2_hanabi_checkpoints_r3d2/5/20/e/epoch1880.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/5/20/a/epoch2000.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/2/20/d/epoch2200.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/3/20/c/epoch2000.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/R2D2-text-S/4/20/c/epoch2400.pthw"
  ...
  "${SCRATCH}/final_hanabi_checkpoint/multitask_learning_no_saved_buffer/6/20/c/epoch3220.pthw"
  "${SCRATCH}/final_hanabi_checkpoint/random_agent/2p/epoch0.pthw"
)
