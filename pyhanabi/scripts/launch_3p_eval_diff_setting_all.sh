...
players=('/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/3/20/a/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/3/20/a/epoch2500.pthw') # 'IQL-5a'
alternatives_2=( '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/3/20/b/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/3/20/b/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/2/20/b/epoch2000.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/4/20/a/epoch2480.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/5/20/a/epoch2000.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/2/20/a/epoch2500.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/4/20/a/epoch2500.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/5/20/b/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/multitask_learning_no_saved_buffer/6/20/a/epoch3320.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/random_agent/2p/epoch0.pthw') # 'IQL-5b' 'R3-2b' 'R3-3b' 'R3-4b' 'R2T-2b' 'R2T-3b' 'R2T-4b'
alternatives_3=( '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/3/20/c/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/3/20/c/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/2/20/c/epoch2000.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/4/20/b/epoch2860.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/R2D2-text-S/5/20/b/epoch2000.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/2/20/b/epoch2500.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/4/20/b/epoch2500.pthw' '/home/mila/m/mathieu.reymond/scratch/v2_hanabi_checkpoints_r3d2/5/20/c/epoch2500.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/multitask_learning_no_saved_buffer/6/20/b/epoch3280.pthw' '/home/mila/n/nekoeiha/scratch/final_hanabi_checkpoint/random_agent/2p/epoch0.pthw')  # 'R3-2c' 'R3-3c' 'R3-4c' 'R2T-2c' 'R2T-3c' 'R2T-4c'
...
#            if [[ ! ($r3_2_count -gt 0 && $r2_2_count -gt 0 && $r3_4_count -gt 0 && $r2_4_count -gt 0 && $r3_5_count -gt 0 && $r2_5_count -gt 0) ]]; then
            total_positive=$(( (r3_2_count > 0) + (r2_2_count > 0) + (r3_4_count > 0) + (r2_4_count > 0) + (r3_5_count > 0) + (r2_5_count > 0) ))
            if [[ $total_positive -lt 2 ]]; then
                if [[ $j -ge $i && $k -ge $j ]]; then
                    pair_list+=("${players[$i]},${alternatives_2[$j]},${alternatives_3[$k]}")
                fi
            fi
        done
    done
...
for pair in "${pair_list[@]}"; do
      echo "Running evaluation for $file with --num_player 3 --weights $pair --seed $SEED"
      ...
      while [ $attempt -le $max_attempts ]; do
          python eval_model_diff.py --weights "$pair" --num_player 3 --seed $SEED
          if [ $? -eq 0 ]; then
