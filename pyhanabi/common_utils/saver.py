...
class TopkSaver:
    ...
    def save(self, state_dict,optim_dict,replay_buffer, perf, *, save_latest=False, force_save_name=None,force_save_name_optim=None,force_replay_buffer_path=None, config=None):
        if force_save_name is not None:
            ...
            replay_name = os.path.join(self.save_dir, "%s.pth" % force_replay_buffer_path)
        ...
        optim_name = os.path.join(self.save_dir, "model_optim%i.pthw" % self.worse_perf_idx)
