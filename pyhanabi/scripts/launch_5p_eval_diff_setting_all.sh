        ...
        for ((k=0; k<${#alternatives_3[@]}; k++)); do
            for ((m=0; m<${#alternatives_4[@]}; m++)); do
                for ((n=0; n<${#alternatives_5[@]}; n++)); do
                  ...
                  [[ ${alternatives_3[$k]} == *"r3d2/4/"* ]] && ((r3_4_count++))
                  [[ ${alternatives_4[$m]} == *"r3d2/2/"* ]] && ((r3_2_count++))
                  [[ ${alternatives_4[$m]} == *"r3d2/3/"* ]] && ((r3_3_count++))
                  [[ ${alternatives_4[$m]} == *"r3d2/4/"* ]] && ((r3_4_count++))
                  [[ ${alternatives_5[$n]} == *"r3d2/2/"* ]] && ((r3_2_count++))
                  [[ ${alternatives_5[$n]} == *"r3d2/3/"* ]] && ((r3_3_count++))
                  [[ ${alternatives_5[$n]} == *"r3d2/4/"* ]] && ((r3_4_count++))

                  [[ ${alternatives_2[$j]} == *"R2D2-text-S/2/"* ]] && ((r2_2_count++))
                  [[ ${alternatives_2[$j]} == *"R2D2-text-S/3/"* ]] && ((r2_3_count++))
                  [[ ${alternatives_2[$j]} == *"R2D2-text-S/4/"* ]] && ((r2_4_count++))
                  [[ ${alternatives_3[$k]} == *"R2D2-text-S/2/"* ]] && ((r2_2_count++))
                  [[ ${alternatives_3[$k]} == *"R2D2-text-S/3/"* ]] && ((r2_3_count++))
                  [[ ${alternatives_3[$k]} == *"R2D2-text-S/4/"* ]] && ((r2_4_count++))
                  [[ ${alternatives_4[$m]} == *"R2D2-text-S/2/"* ]] && ((r2_2_count++))
                  [[ ${alternatives_4[$m]} == *"R2D2-text-S/3/"* ]] && ((r2_3_count++))
                  [[ ${alternatives_4[$m]} == *"R2D2-text-S/4/"* ]] && ((r2_4_count++))
                  [[ ${alternatives_5[$n]} == *"R2D2-text-S/2/"* ]] && ((r2_2_count++))
                  [[ ${alternatives_5[$n]} == *"R2D2-text-S/3/"* ]] && ((r2_3_count++))
                  [[ ${alternatives_5[$n]} == *"R2D2-text-S/4/"* ]] && ((r2_4_count++))

                  # Only add combination if we don't have both R3-2* and R3-3* present
                  total_positive=$(( (r3_2_count > 0) + (r2_2_count > 0) + (r3_3_count > 0) + (r2_3_count > 0) + (r3_4_count > 0) + (r2_4_count > 0) ))
...
for pair in "${pair_list[@]}"; do
      echo "Running evaluation for $file with --num_player 5 --weights $pair --seed $SEED"
      ...
      while [ $attempt -le $max_attempts ]; do
          python eval_model_diff.py --weights "$pair" --num_player 5 --seed $SEED
          if [ $? -eq 0 ]; then
